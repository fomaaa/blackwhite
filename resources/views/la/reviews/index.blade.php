...
@section("contentheader_title", "Reviews")
@section("contentheader_description", "Reviews listing")
@section("section", "Reviews")
@section("sub_section", "Listing")
@section("htmlheader_title", "Reviews Listing")

@section("headerElems")
@la_access("Reviews", "create")
...
<div class="modal fade" id="AddModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			{!! Form::open(['action' => 'LA\ReviewsController@store', 'id' => 'review-add-form']) !!}
