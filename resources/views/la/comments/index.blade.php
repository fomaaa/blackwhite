...
@section("contentheader_title", "Comments")
@section("contentheader_description", "Comments listing")
@section("section", "Comments")
@section("sub_section", "Listing")
@section("htmlheader_title", "Comments Listing")

@section("headerElems")
@la_access("Comments", "create")
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/comment_dt_ajax') }}",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
