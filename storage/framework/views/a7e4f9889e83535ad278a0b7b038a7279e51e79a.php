<div style="background:#eee;padding:30px;">
	<div style="background:#fff;padding: 15px 20px;width: 550px;border: 1px solid #e3e3e5;border-radius:3px;margin: 0 auto;font: normal 13px/19px Verdana;box-shadow: 0 3px 7px rgba(0,0,0,.1);">
		...
		<div style="padding: 15px 0;"> 
			Уважаемый <b><?php echo e($user->name); ?></b>. Вы сделали запрос на регистрацию на сайте bw-list, перейдите по ссылке ниже, чтобы подтвердить ваш email и ожидайте подтверждения вашего аккаунта администратором		</div>
		...
		<div style="padding: 15px 0;"> 
			Если вы не делали запроса для регистрации, то просто удалите данное письмо. 
		</div>
	</div>
</div>