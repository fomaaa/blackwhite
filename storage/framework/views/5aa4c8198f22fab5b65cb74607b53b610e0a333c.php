<?php $__env->startSection("contentheader_title"); ?>
	<a href="<?php echo e(url(config('laraadmin.adminRoute') . '/permissions')); ?>">Permissions</a> :
...
<?php $__env->startSection("htmlheader_title", "Permission Edit : ".$permission->$view_col); ?>
				...
				<?php echo Form::model($permission, ['route' => [config('laraadmin.adminRoute') . '.permissions.update', $permission->id ], 'method'=>'PUT', 'id' => 'permission-edit-form']); ?>
					...
					*/ ?>
					...
					<div class="form-group">
						<?php echo Form::submit( 'Update', ['class'=>'btn btn-success']); ?> <button class="btn btn-default pull-right"><a href="<?php echo e(url(config('laraadmin.adminRoute') . '/permissions')); ?>">Cancel</a></button>
					</div>
				<?php echo Form::close(); ?>
