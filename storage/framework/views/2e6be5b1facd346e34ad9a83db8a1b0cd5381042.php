<?php $__env->startSection("contentheader_title", "Clients"); ?>
<?php $__env->startSection("contentheader_description", "Clients listing"); ?>
<?php $__env->startSection("section", "Clients"); ?>
<?php $__env->startSection("sub_section", "Listing"); ?>
<?php $__env->startSection("htmlheader_title", "Clients Listing"); ?>

<?php $__env->startSection("headerElems"); ?>
<?php if(LAFormMaker::la_access("Clients", "create")) { ?>
...
<div class="modal fade" id="AddModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<?php echo Form::open(['action' => 'LA\ClientsController@store', 'id' => 'client-add-form']); ?>
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "<?php echo e(url(config('laraadmin.adminRoute') . '/client_dt_ajax')); ?>",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
