...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name"><?php echo e($review->$view_col); ?></h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			<?php if(LAFormMaker::la_access("Reviews", "edit")) { ?>
				<a href="<?php echo e(url(config('laraadmin.adminRoute') . '/reviews/'.$review->id.'/edit')); ?>" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			<?php } ?>
			
			<?php if(LAFormMaker::la_access("Reviews", "delete")) { ?>
				<?php echo e(Form::open(['route' => [config('laraadmin.adminRoute') . '.reviews.destroy', $review->id], 'method' => 'delete', 'style'=>'display:inline'])); ?>
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="<?php echo e(url(config('laraadmin.adminRoute') . '/reviews')); ?>" data-toggle="tooltip" data-placement="right" title="Back to Reviews"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						<?php echo LAFormMaker::display($module, 'links'); ?>
						<?php echo LAFormMaker::display($module, 'review'); ?>
						<?php echo LAFormMaker::display($module, 'author'); ?>
						<?php echo LAFormMaker::display($module, 'anon'); ?>
					</div>
				</div>
			</div>
		</div>
