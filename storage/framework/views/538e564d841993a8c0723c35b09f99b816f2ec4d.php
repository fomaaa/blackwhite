<?php $__env->startSection("contentheader_title", "Departments"); ?>
<?php $__env->startSection("contentheader_description", "Departments listing"); ?>
<?php $__env->startSection("section", "Departments"); ?>
<?php $__env->startSection("sub_section", "Listing"); ?>
<?php $__env->startSection("htmlheader_title", "Departments Listing"); ?>
...
<div class="modal fade" id="AddModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<?php echo Form::open(['action' => 'LA\DepartmentsController@store', 'id' => 'department-add-form']); ?>
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "<?php echo e(url(config('laraadmin.adminRoute') . '/department_dt_ajax')); ?>",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
