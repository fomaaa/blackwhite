	...
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name"><?php echo e($user->$view_col); ?></h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			<?php if(LAFormMaker::la_access("Users", "edit")) { ?>
				<a href="<?php echo e(url(config('laraadmin.adminRoute') . '/users/'.$user->id.'/edit')); ?>" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			<?php } ?>
			
			<?php if(LAFormMaker::la_access("Users", "delete")) { ?>
				<?php echo e(Form::open(['route' => [config('laraadmin.adminRoute') . '.users.destroy', $user->id], 'method' => 'delete', 'style'=>'display:inline'])); ?>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						<?php echo LAFormMaker::display($module, 'password'); ?>
