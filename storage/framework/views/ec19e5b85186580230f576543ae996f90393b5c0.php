<?php $__env->startSection("contentheader_title"); ?>
	<a href="<?php echo e(url(config('laraadmin.adminRoute') . '/departments')); ?>">Department</a> :
...
<?php $__env->startSection("htmlheader_title", "Departments Edit : ".$department->$view_col); ?>
